...
contract GreenCreditToken is ERC20 {
    address payable public EcoZapPlatformOwner;
    ...
    constructor(uint initTokenPrice) ERC20("GreenCredit", "GCT") {
        EcoZapPlatformOwner = payable(msg.sender);
        tokenPrice = initTokenPrice;
        _mint(EcoZapPlatformOwner, 100 * 10**decimals());
    }

    modifier onlyPlatformOwner() {
        require(
            msg.sender != EcoZapPlatformOwner,
